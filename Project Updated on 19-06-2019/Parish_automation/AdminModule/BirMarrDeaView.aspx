...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style9">
        ...
        <tr>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <%--<asp:DropDownList ID="fromdayDrop" runat="server" CssClass="auto-style19" Height="19px" Width="89px">
                    <asp:ListItem></asp:ListItem>
                </asp:DropDownList>--%>
                <asp:TextBox ID="txtFromDay" runat="server" TextMode="Date" ></asp:TextBox>
&nbsp; To&nbsp;
               <%-- <asp:DropDownList ID="todayDrop" runat="server">
                </asp:DropDownList>--%>
