...
namespace Parish_automation.classes
{
    public class death
    {
        ...
        public void InsertMember_Parameter()
        {
            ...
            SqlCommand cmd = new SqlCommand("update  family_information1 set date_of_death=@dateofdeath,date_of_funeral=@dateoffuneral,death_reason=@deathreasonmname, status=@death where familyid=@familyid1 and name=@name",con);
