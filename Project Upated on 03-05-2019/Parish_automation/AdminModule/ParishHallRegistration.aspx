<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/AdminModuleMain.Master" AutoEventWireup="true" CodeBehind="ParishHallRegistration.aspx.cs" Inherits="Parish_automation.AdminModule.ParishHallRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style9">
        ...
        <tr>
            <td colspan="2">Parish Hall Register Request</td>
        </tr>
        <tr>
