...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        ...
        <td class="text-justify">
            ...
            <span style="font-family: Arial; font-weight: bold; font-size: xx-large">SEHION ORTHODOX CHURCH</span></td>
    </tr>
    <tr>
        <td style="width: 7px">&nbsp;</td>
        <td>
            <table class="nav-justified" style="height: 403px">
                ...
                <tr>
                    ...
                    <td style="height: 42px; width: 503px">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtemail" ErrorMessage="Enter Vlid EmailId"></asp:RequiredFieldValidator>
                    </td>
                    <td style="height: 42px">&nbsp;</td>
                </tr>
                <tr>
