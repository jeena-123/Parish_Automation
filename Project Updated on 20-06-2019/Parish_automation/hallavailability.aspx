...
&nbsp;<span style="font-family: 'Times New Roman', Times, serif; font-weight: bold; font-size: large">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span><span style="font-family: Algerian; font-weight: bold; font-size: large; color: #008080;">Sehion Center Online Booking</span></td>
    </tr>
    <tr>
        <td class="text-center" colspan="3">&nbsp;</td>
    </tr>
    <tr>
        <td class="text-left" style="font-family: 'Times New Roman', Times, serif; font-weight: bold; font-size: medium" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Check Availability</td>
    </tr>
    <tr>
        <td class="text-center" colspan="3">&nbsp;</td>
    </tr>
    <tr>
        <td class="text-left" style="height: 37px" colspan="3">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="eventdate" runat="server" Height="24px" Width="159px" TextMode="Date" AutoPostBack="true" OnTextChanged="eventdate_TextChanged"></asp:TextBox>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Parish Hall&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <tr>
        ...
        <td class="text-center" style="width: 545px">
            <asp:Label ID="LblMsg" runat="server" Text="Please Select Valid Date" Visible="False" ForeColor="#FF0066"></asp:Label>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr>
