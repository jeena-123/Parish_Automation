    ...
    <table class="auto-style9">
        ...
        <tr>
            ...
            <td class="auto-style31">
                    <asp:DropDownList ID="ddlist" runat="server" DataTextField="family" DataValueField="family_id" AutoPostBack="true" OnSelectedIndexChanged="ddlist_SelectedIndexChanged">
        ...
        <tr>
            ...
            <td colspan="3">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" Text="SAVE" OnClick="Button1_Click1" Height="36px" Width="154px" />
                </td>
        </tr>
        <tr>
            <td class="auto-style10">&nbsp;</td>
