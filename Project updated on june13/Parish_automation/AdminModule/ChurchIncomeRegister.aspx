...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        <td class="auto-style14">
            <asp:DropDownList ID="ddlfamilyid" DataValueField="family_id" DataTextField="family_id" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlfamilyid_SelectedIndexChanged" Width="167px">
    ...
    <tr>
        ...
        <td class="auto-style16">
            <asp:DropDownList ID="ddlfamilymembers" runat="server" DataValueField="member_id" DataTextField="name" AutoPostBack="true" OnSelectedIndexChanged="ddlfamilymembers_SelectedIndexChanged" Width="166px">
            <asp:ListItem>.......Select.......</asp:ListItem>
            </asp:DropDownList>
        </td>
    </tr>
