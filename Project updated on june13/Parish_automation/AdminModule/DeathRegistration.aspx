    ...
    <table class="auto-style9">
        ...
        <tr>
            ...
            <td class="auto-style20">
                    <asp:DropDownList ID="DropDownList1" runat="server" DataValueField="familyid" DataTextField="familyid" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Height="19px" Width="169px">
        ...
        <tr>
            ...
            <td class="auto-style20">
                    <asp:DropDownList ID="ddlnamedeath" runat="server" DataValueField="member_id" DataTextField="name" AutoPostBack="true" OnSelectedIndexChanged="ddlnamedeath_SelectedIndexChanged" Height="19px" Width="169px">
                         <asp:ListItem>......select....</asp:ListItem>
                    </asp:DropDownList>
                </td>
            <td class="auto-style20"></td>
        ...
        <tr>
            ...
            <td class="auto-style11">
                    <asp:TextBox ID="txtdeathreason" runat="server"  TextMode="MultiLine" Width="162px"></asp:TextBox>
                </td>
            <td class="auto-style11">&nbsp;</td>
        </tr>
        <tr>
