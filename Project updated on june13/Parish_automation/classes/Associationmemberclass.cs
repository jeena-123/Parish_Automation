...
namespace Parish_automation.classes
{
    public class Associationmemberclass
    {
        ...
        {
            OpenConection();
            string qry = "insert into Masavari(family_id,kendravihitham,Masavari) values(@familyid,@kendravihitham,@masavari);";
            SqlCommand cmd = new SqlCommand(qry, con);
        ...
        {
            OpenConection();
            string qry = "update Masavari set kendravihitham=@kendravihitham,Masavari=@masavari where family_id=@familyid;";
            SqlCommand cmd = new SqlCommand(qry, con);
        ...
        {
            OpenConection();
            string qry = "insert into ChurchIncomeRegister(expensedate,expensedescription,expenseamount) values(@expdate,@expdescription,@expamount);";
            SqlCommand cmd = new SqlCommand(qry, con);
