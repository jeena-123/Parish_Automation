...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style10">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlcertificate" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlcertificate_SelectedIndexChanged">
                    <asp:ListItem>....Select......</asp:ListItem>
        ...
        <tr>
            ...
            <td class="auto-style13">
                <asp:TextBox ID="deadname" runat="server" CssClass="form-control"></asp:TextBox>
            </td>
            <td class="auto-style14">
                <asp:Label ID="Label6" runat="server" Text="Purpose"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtpurpose" runat="server" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style11">&nbsp;</td>
