...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style9">
        ...
        <tr>
            <td class="auto-style10" colspan="2">V<strong>iew Birthday Marriage And Death Details&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></td>
        </tr>
        <tr>
            <td class="auto-style12">&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlselect" runat="server">
                    ...
                    <asp:ListItem>Baptisam Date</asp:ListItem>
                    <asp:ListItem>Marriage Date</asp:ListItem>
                    <asp:ListItem>Death Date</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
