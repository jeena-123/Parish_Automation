...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="nav-justified" style="height: 493px">
        <tr>
            <td class="text-left" style="font-family: Arial; font-weight: bold; font-size: xx-large; height: 67px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image1" runat="server" Height="111px" ImageUrl="~/Image/web-logo.gif" Width="111px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; SEHION&nbsp; ORTHODOX&nbsp;&nbsp; CHURCH</td>
        </tr>
        <tr>
            <td>
                <asp:Image ID="Image2" runat="server" Height="370px" ImageUrl="~/Image/images.jpg" Width="1300px" BorderStyle="Solid" />
            </td>
        </tr>
        <tr>
            <td>
                <table class="nav-justified" style="height: 507px">
                    <tr>
                        <td style="width: 242px; height: 111px;">
                            <asp:Image ID="Image3" runat="server" ImageUrl="~/Image/download.jpg" style="margin-top: 78px" Width="236px" />
                        </td>
                        <td style="width: 623px; height: 111px;">
...
&nbsp;chosen by His Grace to commemorate the Sehion Banglove where the disciples and Christ
                    ...
                    <tr>
                        <td style="width: 242px; height: 107px;">
                        </td>
                        <td style="width: 623px; height: 107px;">
                        </td>
