...
namespace Parish_automation.classes
{
    public class MemberInfoClass
    {
        ...
        {
            OpenConection();
            string qry = "insert into family_information1(name,relationwithfamilyhead,dob,gender,mobno,dateofbaptisam,email_id,blood_group,family_income,marital_status,marriage_date,qualification,occupation,familyid) values(@name,@relationwithfamilyhead,@dob,@gender,@mobno,@dateofbaptisam,@emailid,@bloodgrp,@familyincome,@maritalstatus,@marriagedate,@qualification,@occupation,@familyidy);";
