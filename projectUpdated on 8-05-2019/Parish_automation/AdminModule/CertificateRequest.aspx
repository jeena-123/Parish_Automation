...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style9">
        ...
        <tr>
            <td>
                <asp:GridView ID="GridViewCertificate" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource2" GridLines="None" ForeColor="#333333" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDataBound="GridViewCertificate_RowDataBound">
