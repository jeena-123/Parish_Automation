...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style45">
        ...
        <div>
            ...
            <table>
                <tr>
                    <td class="auto-style72" rowspan="4">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label6" runat="server" Text="Mobile No" Font-Size="Medium"></asp:Label>
                    </td>
                    <td>
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="4" class="auto-style69"><span class="auto-style22"><span class="auto-style25">Family Member Details</span></span></td>
        </tr>
        <tr>
